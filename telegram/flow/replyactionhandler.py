...
class ReplyActionHandler(Handler):
    ...
    def __init__(self,
        ...
        super(ReplyActionHandler, self).__init__(
            callback,
    ...
    def collect_additional_context(self, context, update, dispatcher, check_result):
        ...
        callback_item = dispatcher.callback_manager.lookup_chat_bound_callback(chat, check_result)
